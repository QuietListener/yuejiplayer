...
{
    public final static String TAG = "ChooseVideoActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            Toast.makeText(ChooseVideoActivity.this,
...
//              }
                ...
                {
                    Toast.makeText(ChooseVideoActivity.this, "请选择视频文件，字幕与视频同名喔~" ,Toast.LENGTH_SHORT).show();
                }
            }
        });
